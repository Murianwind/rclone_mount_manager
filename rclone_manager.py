...
class App(tk.Tk):
    ...
    def _build_ui(self):
        """image_abe4d4.png 레이아웃 (5개 컬럼, 하단 8개 버튼) 100% 복구"""
    ...
    def _check_rclone_presence(self):
        """[Scenario 28] rclone 파일 확인 및 문구 변경"""
